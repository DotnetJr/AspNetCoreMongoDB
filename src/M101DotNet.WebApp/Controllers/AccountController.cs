...
using M101DotNet.WebApp.Models.AccountViewModels;
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var mongoUser = await col.Find(filter).FirstOrDefaultAsync();
                    
                    if (mongoUser == null)
                    {
                        mongoUser = new MongoUser { Name = model.Email, Email = model.Email };
                        await col.InsertOneAsync(mongoUser);
                    }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var mongoUser = new MongoUser { Name = model.Email, Email = model.Email };
                    await col.InsertOneAsync(mongoUser);
